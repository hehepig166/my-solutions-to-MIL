...
theorem add_left_cancel {a b c : R} (h : a + b = a + c) : b = c := by
  rw [← add_neg_cancel_left a b]
  rw [add_comm (-a) b, ← add_assoc, h]
  rw [add_comm, ← add_assoc, neg_add_cancel, zero_add]
...
theorem mul_inv_rev (a b : G) : (a * b)⁻¹ = b⁻¹ * a⁻¹ := by
  ...
  rw [mul_assoc, mul_assoc a b, ← mul_assoc b, mul_inv_cancel, one_mul, mul_inv_cancel, mul_one]
